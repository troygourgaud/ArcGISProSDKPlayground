...
using ProConfigurationConfigTest.UI;
...
namespace ProConfigurationConfigTest
{
    internal class ConfigurationManager1 : ConfigurationManager
    {
        ...
        {
            get { return "ProConfigurationConfigTest"; }
        }
        ...
        protected override ImageSource Icon
        {
            get
            {
                return new BitmapImage(new Uri(@"pack://application:,,,/ProConfigurationConfigTest;component/Images/favicon.ico"));
            }
        }
